...
if __name__ == '__main__':
	...
	parse.add_argument('--name', '-n', type=str, default='resnet18')
	parse.add_argument('--train_list', '-tl' , type=str, default = './List_training_1.txt')
	...
	parse.add_argument('--model_name', '-mn', type=str, default='resnet18_2.pkl')
